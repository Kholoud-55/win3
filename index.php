...
<body>
     ...
     <div class="col-md-5 p-lg-5 mx-auto my-5">
       ...
       <h1 class="display-4 fw-normal text-warning">اربح مع نور </h1>
       <p class="lead fw-normal">باقي على فتح التسجيل</p>
       <p class="lead fw-normal text-info">للسحب على سحب نسحةمجانيةمن برنامج</p>
       <a class="btn btn-outline-secondary" href="#">Coming soon</a>
     </div>
     <div class="container">
     <ul class="list-group">
      <li class="list-group-item active" aria-current="true">اكتشف كيفية كسب الأرباح</li>
